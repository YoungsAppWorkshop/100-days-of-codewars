...
Gap in Primes
    ...
    From 7 to 11 it is 4. Between 2 and 50 we have the following pairs
    ...
    #Examples: gap(2, 5, 7) --> [5, 7] or (5, 7) or {5, 7}
        ...
        103, 107, 109 but 101-107is not a 6-gap because there is 103in between
