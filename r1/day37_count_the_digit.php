...
/*
  ...
  nb_dig(25, 1): the numbers of interest are 1, 4, 9, 10, 11, 12, 13, 14,
  19, 21 which squared are 1, 16, 81, 100, 121, 144, 169, 196, 361, 441
...
function nbDig($n, $d) {
  ...
  return substr_count($str, (string) $d);
}
