...
Best travel
    ...
    John is tired of driving and he says to Mary that he doesn't want to
    ...
    The sums of distances are then: 162, 163, 165, 165, 167, 168, 170, 172,
    173, 175.
    ...
    language) will take as parameters
    ...
    distances less than or equal to the given limit t, if that sum exists,
...
def choose_best_sum(t, k, ls):
    distances = [x for x in map(sum, list(combinations(ls, k))) if x <= t]
    return max(distances) if len(distances) > 0 else None
