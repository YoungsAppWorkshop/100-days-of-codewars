/***
  ...
  Functional programming thrives from the reuse of functions. One core feature
  to extend the reuse is the concatenation of functions.
  ...
  Since a function only can return one value it is absolutely sufficient to
