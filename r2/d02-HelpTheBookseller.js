...
Help the bookseller !
  ...
  Each book has a code c of 3, 4, 5 or more capitals letters. The 1st letter of
  a code is the capital letter of the book category. In the bookseller's
  stocklist each code c is followed by a space and by a positive integer n
...
function stockList(listOfArt, listOfCat){
  return listOfArt.length ?
    listOfCat.map(cat => `(${cat} : ${listOfArt
    .filter(code => code[0] === cat)
